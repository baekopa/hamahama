...
@Slf4j
@Schema(description = "presentation logic error 처리 handler")
...
public class GlobalExceptionHandler {
     ...
     */
    @Schema(description = "API 호출 시 '객체' 혹은 '파라미터' 데이터 값이 유효하지 않은 경우")
     ...
     * @return ResponseEntity<ErrorResponse>
     */
    @Schema(description = "API 호출 시 'Header' 내에 데이터 값이 유효하지 않은 경우")
     ...
     * @return ResponseEntity<ErrorResponse>
     */
    @Schema(description = "클라이언트에서 Body로 '객체' 데이터가 넘어오지 않았을 경우")
     ...
     * @return ResponseEntity<ErrorResponse>
     */
    @Schema(description = "클라이언트에서 request로 '파라미터로' 데이터가 넘어오지 않았을 경우")
     ...
     * @return ResponseEntity<ErrorResponse>
     */
    @Schema(description = "잘못된 서버 요청일 경우 발생한 경우")
     ...
     * @return ResponseEntity<ErrorResponse>
     */
    @Schema(description = "잘못된 주소로 요청 한 경우")
     ...
     * @return ResponseEntity<ErrorResponse>
     */
    @Schema(description = "NULL 값이 발생한 경우")
     ...
     * @return ResponseEntity<ErrorResponse>
     */
    @Schema(description = "Input / Output 내에서 발생한 경우")
     ...
     * @return ResponseEntity<ErrorResponse>
     */
    @Schema(description = "com.fasterxml.jackson.core 내에 Exception 발생하는 경우")
     ...
     * @return ResponseEntity<ErrorResponse>
     */
    @Schema(description = "모든 Exception 경우 발생")
